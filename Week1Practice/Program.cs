...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("My name is" + myName + " and I'm a beast of a programer");
            ...
            // 4. Using a For loop, print out each value in productsList.
              ...
              for (int i = 0; i < productList.Length; i++)  productList.Count
            {
            ...
            //got help on this one...don't understand it really.  
